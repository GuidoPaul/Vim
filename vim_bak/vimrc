...
if g:config.vim8 || g:config.nvim
    ...
    " let g:ale_echo_msg_error_str = g:config.gui ? 'Error' : '✹ Error'
    " let g:ale_echo_msg_warning_str = g:config.gui ? 'Warning' : '⚠ Warning'
    ...
    let g:syntastic_python_pep8_args='--ignore=E501,E225,E129,W503,W504,W605,E402'
